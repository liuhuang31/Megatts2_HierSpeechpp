...
def main():
    ...
    parser.add_argument('--ckpt_text2w2v', '-ct', help='text2w2v checkpoint path', default='./models/G.pth')
    parser.add_argument('--ckpt_plm', '-cp', help='plm checkpoint path', default='./model/PLM1.pth')
